...
----------------------------------------------------------------------------------------------------------------------
### UPDATE HISTORY
   : Previous Update List before S11
  https://docs.google.com/document/d/15kbZSRRPhfTrehFSQHBgoh_rFrf38TQDNBSsV9RHv6g/edit?usp=sharing

----------------------------------------------------------------------------------------------------------------------
     1. 29.Nov
      1) Uploaded S12 filter (Starter updated)
        - Need to add flat damage option for quivers 
        - Need to update Sound
      
----------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------
     2. 23.Dec
      1) Key has map tips for all maps exclude maps 
      2) horadric cube has the information of current filter level outside of town.
      
----------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------
     3. 27.Dec
      1) Skovos Stronghold immun. info updated. 
...
----------------------------------------------------------------------------------------------------------------------
     4. 28.Dec
      1) Quiver has socket and upgrading recipe
...
----------------------------------------------------------------------------------------------------------------------
     5. 29.Dec
      1) 3Socket weapon can have Crescent Moon Runeword recipe 
...
----------------------------------------------------------------------------------------------------------------------
     6. 31.Dec
      1) Now Allfitlers can drop the Magic quivers
        -. Starter filter (Excpetional and elite base)
        -. The others (only elite base)
...
----------------------------------------------------------------------------------------------------------------------
     7. 4.Jan
      1) LLD option update (Charms/Jewel/Items)
      2) WSS has comments
...
----------------------------------------------------------------------------------------------------------------------
     8. 6.Jan
      1) Unique / Set has comments for usage function.
      2) After desecreation, amulet has marking!
      3) Head hunter glory drop level change 
      
----------------------------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------------------------
     9. 8.Jan
      1) Hype POE sound version uploaded
      
----------------------------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------------------------
     10. 16.Jan
      1) Unique drop level change 
      
----------------------------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------------------------
     11. 18.Jan
      1) Poe sound for ingredient for ubers 
      
----------------------------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------------------------
     12. 26.Jan
      1) Map's title has Density/Rairity/Magic and Find values 
      2) Change drop conditions of scepters (only notification of war scepter class)
      
----------------------------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------------------------
     12. 31.Jan
      1) DOT CHANGED MAP ICONS 
      2) Chest and nec shiled and wand turn to drop notification.
